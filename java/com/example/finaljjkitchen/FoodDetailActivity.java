...
import com.example.finaljjkitchen.Model.Rating;
...
public class FoodDetailActivity extends AppCompatActivity implements View.OnClickListener, RatingDialogListener {
    ...
    TextView food_name, food_price, food_description, backBtn;
    ImageView img_food;
    ...
    private void showRatingDialog() {
            new AppRatingDialog.Builder()
                    ...
                    .create(com.example.finaljjkitchen.FoodDetailActivity.this)
                    .show();
    }
