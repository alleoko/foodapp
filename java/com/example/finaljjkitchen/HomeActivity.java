...
import com.example.finaljjkitchen.ViewHolders.MenuViewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(com.example.finaljjkitchen.HomeActivity.this, com.example.finaljjkitchen.CartActivity.class);
...
//        recyclerView_menu.setLayoutManager(new LinearLayoutManager(this, VERTICAL, false));
            ...
            protected void onBindViewHolder(@NonNull MenuViewHolder holder, int position, @NonNull final Category model)
            {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onclick(View view, int position, boolean isLongClick) {
                        ...
                        Intent intentFood = new Intent(com.example.finaljjkitchen.HomeActivity.this, com.example.finaljjkitchen.FoodActivity.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_restaurant) {
            ...
            Intent intent = new Intent(com.example.finaljjkitchen.HomeActivity.this, OrderStatusActivity.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(com.example.finaljjkitchen.HomeActivity.this, com.example.finaljjkitchen.MainActivity.class);
