...
import com.example.finaljjkitchen.Server.HomeActivityServer;
import com.example.finaljjkitchen.Server.MainActivityServer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            @SuppressLint("PackageManagerGetSignatures") PackageInfo info =
                    getPackageManager().getPackageInfo("com.example.jamesandjacobkitchen.food_order",
        ...
        if (Common.isInternetAvailable(this)) {
            if (v.getId() == R.id.btnClient) {
                ...
                if (phone != null && password != null && name != null) {
                    Intent intent = new Intent(com.example.finaljjkitchen.ChooseActivity.this, HomeActivity.class);
                    startActivity(intent);
                    Common.currentUser = new User(name, password, phone, "false");
                    finish();
                } else {
                    Intent intent = new Intent(com.example.finaljjkitchen.ChooseActivity.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                }
                ...
                if (phone != null && password != null && name != null) {
                    Intent intent = new Intent(com.example.finaljjkitchen.ChooseActivity.this, HomeActivityServer.class);
                    startActivity(intent);
                    Common.currentUser = new User(name, password, phone, "true");
                    finish();
                } else {
                    Intent intent = new Intent(com.example.finaljjkitchen.ChooseActivity.this, MainActivityServer.class);
                    startActivity(intent);
                    finish();
                }
            }
