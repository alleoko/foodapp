...
//    }
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Order, MyViewListOrder> adapter;
        ...
        options = new FirebaseRecyclerOptions.Builder<Order>()
                .setQuery(ref, Order.class).build();
        adapter = new FirebaseRecyclerAdapter<Order, MyViewListOrder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull MyViewListOrder holder, @SuppressLint("RecyclerView") final int position, @NonNull Order order) {
               ...
               String totals = String.valueOf(total);
                ...
                holder.txtPrice.setText(totals);
...
//                        RemoverOrder(uID);
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(com.example.finaljjkitchen.ViewOrders.this);
...
////////////////
            ...
            @NonNull
            @Override
            public MyViewListOrder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_orders, parent, false);

                return new MyViewListOrder(v);
