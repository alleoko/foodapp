...
import com.example.finaljjkitchen.Model.Category;
import com.example.finaljjkitchen.R;
import com.example.finaljjkitchen.Server.ViewHolders.MenuViewHolderServer;
...
import static com.example.finaljjkitchen.Common.Common.SERVER;
...
public class CateringActivityServer extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category = firebaseDatabase.getReference("Catering");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(CateringActivityServer.this, OrderStatusActivityServer.class);
            startActivity(intent);
        }
        if(id == R.id.nav_restaurant)
        {
            Intent intent = new Intent(CateringActivityServer.this, HomeActivityServer.class);
            startActivity(intent);
        }
        if(id == R.id.nav_catering_book)
        {
            Intent intent = new Intent(CateringActivityServer.this, CateringStatusActivityServer.class);
            startActivity(intent);
        ...
        if(id == R.id.nav_cart)
        {
            Intent intent = new Intent(CateringActivityServer.this, SalesActivity.class);
            startActivity(intent);
        }
        if(id == R.id.nav_catering)
        {
            Intent intent = new Intent(CateringActivityServer.this, CateringActivityServer.class);
            startActivity(intent);
        }
        if(id == R.id.nav_sign_out)
        {
            ...
            Intent intent = new Intent(CateringActivityServer.this, MainActivityServer.class);
            ...
            protected void onBindViewHolder(@NonNull MenuViewHolderServer holder, int position, @NonNull final Category model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onclick(View view, int position, boolean isLongClick) {
                        ...
                        Intent intentFood = new Intent(CateringActivityServer.this, CateringMenuActivityServer.class);
                        intentFood.putExtra("cateringID", adapter.getRef(position).getKey());
    ...
    private void addMenuDialog() {
        ...
        alertDialog.setTitle("Add new Catering");

        View view = getLayoutInflater().inflate(R.layout.custom_add_catering_dialog, null);
