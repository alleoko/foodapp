...
import com.example.finaljjkitchen.Mappie;
...
//        displaylocation();
    ...
    private void displaylocation() {
        ...
        else
        {
            ...
            String location = Common.currentRequest.getAddress();
            List<Address> addressList = null;
            if(location !=null || !location.equals("")){
                Geocoder geocoder = new Geocoder(TrackingOrderActivity.this);
                try {
                ...
                Toast.makeText(TrackingOrderActivity.this, location, Toast.LENGTH_SHORT).show();
//
            }
...
//                                    } else {
//                                        // Do something
//                                        Toast.makeText(com.example.finaljjkitchen.Server.TrackingOrderActivity.this, rawBody, Toast.LENGTH_SHORT).show();
//                                        Log.e("key", rawBody);
//                                    }
//                                }
//
...
//                                    Toast.makeText(com.example.finaljjkitchen.Server.TrackingOrderActivity.this, "Cannot draw polyline", Toast.LENGTH_SHORT).show();
//                                }
//                            });
//                }
//                catch (Exception e)
