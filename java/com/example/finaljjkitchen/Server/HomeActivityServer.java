...
public class HomeActivityServer extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(com.example.finaljjkitchen.Server.HomeActivityServer.this, com.example.finaljjkitchen.Server.OrderStatusActivityServer.class);
            startActivity(intent);
        }
        if(id == R.id.nav_catering_book)
        {
            Intent intent = new Intent(HomeActivityServer.this, CateringStatusActivityServer.class);
            startActivity(intent);
        }

        if(id == R.id.nav_cart)
        {
            Intent intent = new Intent(com.example.finaljjkitchen.Server.HomeActivityServer.this, com.example.finaljjkitchen.Server.SalesActivity.class);
            startActivity(intent);
        }
        if(id == R.id.nav_catering)
        {
            Intent intent = new Intent(com.example.finaljjkitchen.Server.HomeActivityServer.this, com.example.finaljjkitchen.Server.CateringActivityServer.class);
            startActivity(intent);
        }
        if(id == R.id.nav_sign_out)
        {
            ...
            Intent intent = new Intent(com.example.finaljjkitchen.Server.HomeActivityServer.this, com.example.finaljjkitchen.Server.MainActivityServer.class);
            ...
            protected void onBindViewHolder(@NonNull MenuViewHolderServer holder, int position, @NonNull final Category model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onclick(View view, int position, boolean isLongClick) {
                        ...
                        Intent intentFood = new Intent(com.example.finaljjkitchen.Server.HomeActivityServer.this, com.example.finaljjkitchen.Server.FoodActivityServer.class);
